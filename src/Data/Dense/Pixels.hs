...
--
-- Helpers for converting between "dense", "JuicyPixels" and "friday"
-- packages.
--
-----------------------------------------------------------------------------
module Data.Dense.Pixels
...
instance Storable PixelRGBF where
  sizeOf ~(PixelRGBF a _ _) = 3 * sizeOf a
  {-# INLINE sizeOf #-}
...
-- | Isomorphism between a "friday" 'F.Manifest' and a "dense" 'SArray'.
